...
input_dim = [1024, 1024, 54, 54, 352, 2]
batch_size = 8
seq_len = 14
...
def main():
    ...
    if mode == "train":
        train_val(model, [data_loader_train, data_loader_val], optimizer, criterion, epochs)  # with smoothed labels
...
def train_val(model, loaders, optimizer, criterion, epochs, resume = False):
    """
