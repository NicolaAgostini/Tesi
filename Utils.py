    ...
    for video in os.listdir(videos_path):
        if video.endswith(".mp4"):
            ...
            if (video.endswith(".mp4")):  # or .avi, .mpeg, whatever.
                os.system('ffmpeg -i /home/2/2014/nagostin/Desktop/video/{0} -vf "scale=-1:256,fps=30" -qscale:v 2 /home/2/2014/nagostin/Desktop/frames/{0}/{0}_frame_%010d.jpg'.format(video))
